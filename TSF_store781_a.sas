PROC IMPORT OUT= WORK.store_781
            DATAFILE= "Store781_a.csv" 
            DBMS=CSV REPLACE;
     GETNAMES=YES;
     DATAROW=2; 
RUN;

title "Sales of Store_781";
proc sgplot data= Store_781;
    series x=date y=weeklysales / ;

	run;

proc forecast data=Store_781
...
title1 "Sales of Store781 type_a";
