PROC IMPORT OUT= WORK.store_335
            DATAFILE= "Store335_b.csv" 
            DBMS=CSV REPLACE;
     GETNAMES=YES;
     DATAROW=2; 
RUN;

title "Sales of Store_335";
proc sgplot data= Store_335;
    series x=date y=weeklysales / ;

	run;

proc forecast data=Store_335
...
title1 "Sales of Store335 type_b";
